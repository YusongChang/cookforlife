<?php
  ...
  if(isset($_POST['collect']) && isset($_POST['id'])){
    ...
    if($collect){
      ...
      if(isset($_POST['collecId'])) Validate::deleteSelfCollection($_POST['collecId'],$_POST['id'],$_COOKIE['cookied'])? Tool::errorMsg('是本人才可以移除！'):true;; //驗證是否為會員本人的收藏
      echo !$model->cancelCollect()? Tool::errorMsg('取 消 失 敗！'):'CANCEL';
    }
