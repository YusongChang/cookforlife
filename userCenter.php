...
<script>
  ...
  <div id="adapt">
    ...
    <div id="fan-collect-recipes">
      <ol>
        <li>收藏：<span id="collections"><?php echo $html->collections;?></span></li>
    ...
    <div id="head-title"><h3>收藏食譜</h3></div>
      <div id="recipe-list">
        <div id="list">
          <?php if($colist){ foreach($colist as $key => $value){ ?>
          <dl>
            <a href="recipe_detail.php?id=<?php echo $value->id;?>">
              <dt><img src="<?php echo $value->finish_img;?>" alt="snapshot"></dt>
            ...
            <dd id="dd-delete">
              <input type="hidden" id="collec_id" value="<?php echo $value->cid;?>"> <!--- 收藏編號--->
              <input type="hidden" id="rec_id" value="<?php echo $value->id;?>"><!--- 被收藏的食譜 id--->
              <a class="delete-btn">移除</a>
            </dd>
          </dl>
