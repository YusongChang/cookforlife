...
<body>
  ...
  <div id="adapt">
    ...
    <div class="recipe_detail">
      ...
      <div id="authorTime">
        <ol>
          <li>試作: <?php if($html->follow_people){echo $html->follow_people;} else echo 0;?></li>
        ...
        <div id="trial-like">
          <button id="trial-btn" class="trial-btn">分享試作</button>
      ...
      <div id="trial-share">
        <?php if($try){?>
          <h3 style="letter-spacing:10px;color:gray;"><?php echo @$_COOKIE['cook']; ?>的試作</h3>
          <div id="trial-img">
            <img src="<?php echo $try->finish_img?>" alt="">
          </div>
          <div id="trial-text">
            <span><?php echo $try->summary?></span>
          </div>
          <div style="text-align:right;margin-top:50px"><a id="trial-edit" act="update" trial-id="<?php echo $try->id;?>" style="cursor:pointer;margin-right:2px">編輯</a> | <a id="trial-other" act="show" style="cursor:pointer;margin-right:110px">看其他人試作</a></div>
        <?php }else{?>
          <div class="finish-trial">
            <canvas id="finishImg"></canvas>
            <input type="file" name="" id="trial-img">
          </div>
          <p>上傳你的成品照</p>
          <div class="finish-text">
            <h4>試 作 心 得<span> (500字)</span></h4>
            <textarea name="" id="finish-summary"  class="finish-summary" placeholder="寫些試作心得吧!"></textarea>
            <div><input class="enter-btn" type="button" id="trial-send" name="send" value="確認送出"></div>
          </div>
          <div style="text-align:right;margin-top:50px"><a id="trial-other" act="show" style="cursor:pointer;margin-right:110px">看其他人試作</a></div>
        <?php }?>
      </div>
      <?php }?>
    </div>
