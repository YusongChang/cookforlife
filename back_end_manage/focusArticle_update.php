...
<head>
  ...
  <link rel="stylesheet" href="stylesheet/focusArticle_update.css">
...
<body>
  ...
  <div id="adapt">
    <div id="article-title">
      <span>標題 :</span>
     <input id="input-title" type="text" placeholder="" value="<?php echo $html->title;?>"> <span id="world-limit">(* 5 - 100個字)</span>
    </div>
    <div id="thumbnail-div">
      <span>封面圖:</span>
      <div id="thumb-img">
        <input type="hidden" name="inputThumb" id="inputThumb" value="<?php echo $html->focus_img;?>">
        <img id="thumbImg" src="<?php echo $html->focus_img;?>" alt="" srcset="">
      </div>
    </div>
    <div id="summary">
      <span>摘要: (* 20 - 500 個字)</span>
      <div id="summ-div">
        <textarea name="" id="summ-text" cols="" rows="5"><?php echo $html->summary?></textarea>
      </div>
    </div>
  </div>
  <div id="sec-adapt">
    <div id="content">
      <span id="content-span">內文:</span>
      <div id="content-text">
        <textarea id="editor" name placeholder="輸入內文" autofocus><p><?php echo $html->content;?></p></textarea> <!--- 重要須加上 <p></p>標籤以供 simditor 正確處理段落...（i.e. h1 h2...等等非 p 標籤)--->
      </div>
    </div>
    <div class="submit">
      <div id="draft-div">
        <label for=""><strong>存為草稿( 暫不公開 )</strong><input type="checkbox" name="draft" id="draft" <?php echo $html->state? 'checked' :'';?> ></label>
      </div>
      <input type="button" id="save" name="save" value="儲　存">
      <input type="button" class="delete-btn" id="delete" name="delete" value="刪除">
    </div>
    <div class="bottom-bar"><a href="focusArticle.php?act=show">返回上一頁</a></div>
  </div>
  <!-- Image Upload Modal -->
  <div id="upImgModal">
